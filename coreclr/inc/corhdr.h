...
#define IsMdInstanceInitializerW(x, str)    (((x) & mdRTSpecialName) && !wchar_strcmp((str), COR_CTOR_METHOD_NAME_W))
#define IsMdClassConstructor(x, str)        (((x) & mdRTSpecialName) && !strcmp((str), COR_CCTOR_METHOD_NAME))
#define IsMdClassConstructorW(x, str)       (((x) & mdRTSpecialName) && !wchar_strcmp((str), COR_CCTOR_METHOD_NAME_W))
