...
public:
    ...
    //    - The value of the ConfigurationKnob (searched by name) if it's set (performs a wchar_strtoul).
    ...
    //
    // Returns (in priority order):
    //    - The value of the ConfigurationKnob (searched by name) if it's set (performs a wchar_strtoui64)
    //    - The default value passed in
    ...
    //    - The value of the ConfigurationKnob (searched by name) if it's set (performs a wchar_strcmp with "true").
